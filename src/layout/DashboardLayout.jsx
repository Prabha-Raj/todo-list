...
const DashboardLayout = () => {
  ...
  return (
    <div 
      className={`min-h-screen flex ${darkMode ? 'dark' : 'light'}`}
      style={{ 
    ...
    >
      {/* Desktop Sidebar */}
      <aside 
        className="w-64 hidden md:flex flex-col shadow-md"
        style={{
      ...
      >
        ...
        <nav className="p-4 space-y-2 flex-1">
          {navItems.map((item) => (
            <button
              ...
              className="flex items-center w-full text-left p-2 rounded transition-colors hover:transition-colors"
              style={{ 
        ...
        >
          ...
          <button
            ...
            className="flex items-center w-full py-2 px-3 rounded text-sm transition-colors hover:transition-colors"
            style={{ 
              backgroundColor: theme.danger || "#ef4444",
              color: "white",
              '&:hover': { 
                backgroundColor: theme.dangerHover || "#dc2626" 
              }
            }}
          >
      ...
      <div className="flex-1">
        ...
        >
          ...
          <div className="flex items-center space-x-4">
            ...
            <button 
              onClick={toggleTheme} 
              className="p-1 rounded-full transition-colors hover:transition-colors"
              style={{ 
                color: theme.text,
                '&:hover': { 
                  backgroundColor: theme.hover 
            ...
            <button
              onClick={handleLogout}
              className="hidden md:flex items-center px-3 py-1 rounded text-sm transition-colors hover:transition-colors"
              style={{ 
                backgroundColor: theme.danger || "#ef4444",
                color: "white",
                '&:hover': { 
